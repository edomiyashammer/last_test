...
.btn-primary:focus {
    ...
    background-color: #bd5916;
    border-color: #b15315;
    box-shadow: 0 0 0 .2rem rgba(228, 128, 60, .5)
}
...
.btn-secondary:focus {
    ...
    background-color: #3e4a56;
    border-color: #39444e;
    box-shadow: 0 0 0 .2rem rgba(105, 117, 130, .5)
}
...
.btn-light:focus {
    ...
    background-color: #94a3b2;
    border-color: #8d9dad;
    box-shadow: 0 0 0 .2rem rgba(183, 193, 203, .5)
}
...
.btn-outline-light:focus {
    box-shadow: 0 0 0 .2rem rgba(171, 182, 194, .5)
}
...
.custom-checkbox .custom-control-input:disabled:checked~.custom-control-label::before {
    background-color: rgba(223, 105, 26, .5)
}
...
.custom-range:focus::-webkit-slider-thumb {
    box-shadow: 0 0 0 1px #2b3e50, 0 0 0 .2rem rgba(223, 105, 26, .25)
}
