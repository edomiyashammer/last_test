...
.btn-secondary {
    color: #212121;
    background: #b0b0b0 linear-gradient(180deg, #b0b0b0, #b0b0b0) repeat-x;
    border-color: #b0b0b0
}
...
.custom-range:focus::-webkit-slider-thumb {
    box-shadow: 0 0 0 1px #b0b0b0, 0 0 0 .2rem rgba(33, 150, 243, .25)
}
...
.bg-gradient-secondary {
    background: #b0b0b0 linear-gradient(180deg, #b0b0b0, #b0b0b0) repeat-x !important
}
...
.btn-primary::before {
    ...
    left: 0;
    margin-left: 0;
    background-image: radial-gradient(circle, #b0b0b0 10%, transparent 10.01%);
    background-repeat: no-repeat;
