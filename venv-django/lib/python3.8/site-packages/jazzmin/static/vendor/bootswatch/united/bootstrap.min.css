...
.form-control:focus {
    ...
    border-color: #f4ad94;
    outline: 0;
    box-shadow: 0 0 0 .2rem rgba(233, 84, 32, .25)
}
...
.was-validated .form-control:valid:focus {
    border-color: #38b44a;
    box-shadow: 0 0 0 .2rem rgba(56, 180, 74, .25)
}
...
.was-validated .form-control:invalid:focus {
    border-color: #df382c;
    box-shadow: 0 0 0 .2rem rgba(223, 56, 44, .25)
}
...
.btn-secondary:focus {
    ...
    background-color: #9c948a;
    border-color: #978e83;
    box-shadow: 0 0 0 .2rem rgba(186, 180, 173, .5)
}
...
.btn-success:focus {
    ...
    background-color: #2f973e;
    border-color: #2c8d3a;
    box-shadow: 0 0 0 .2rem rgba(86, 191, 101, .5)
}
...
.btn-warning:focus {
    ...
    background-color: #ecaa1b;
    border-color: #e7a413;
    box-shadow: 0 0 0 .2rem rgba(241, 194, 91, .5)
}
...
.btn-danger:focus {
    ...
    background-color: #c7291e;
    border-color: #bc271c;
    box-shadow: 0 0 0 .2rem rgba(228, 86, 76, .5)
}
...
.btn-dark:focus {
    ...
    background-color: #5b1f3f;
    border-color: #511c39;
    box-shadow: 0 0 0 .2rem rgba(139, 73, 109, .5)
}
...
.btn-outline-primary:focus {
    box-shadow: 0 0 0 .2rem rgba(233, 84, 32, .5)
}
...
.btn-outline-secondary:focus {
    box-shadow: 0 0 0 .2rem rgba(174, 167, 159, .5)
}
...
.btn-outline-success:focus {
    box-shadow: 0 0 0 .2rem rgba(56, 180, 74, .5)
}
...
.btn-outline-warning:focus {
    box-shadow: 0 0 0 .2rem rgba(239, 183, 62, .5)
}
...
.btn-outline-danger:focus {
    box-shadow: 0 0 0 .2rem rgba(223, 56, 44, .5)
}
...
.btn-outline-dark:focus {
    box-shadow: 0 0 0 .2rem rgba(119, 41, 83, .5)
}
...
.custom-checkbox .custom-control-input:disabled:checked~.custom-control-label::before {
    background-color: rgba(233, 84, 32, .5)
}
...
.custom-range:focus::-webkit-slider-thumb {
    box-shadow: 0 0 0 1px #b0b0b0, 0 0 0 .2rem rgba(233, 84, 32, .25)
}
