...
.form-control:focus {
    ...
    border-color: #61c6ed;
    outline: 0;
    box-shadow: 0 0 0 .2rem rgba(21, 140, 186, .25)
}
...
.valid-tooltip {
    ...
    line-height: 1.5;
    color: #b0b0b0;
    background-color: rgba(40, 182, 44, .9);
    border-radius: .25rem
}
...
.was-validated .form-control:valid:focus {
    border-color: #28b62c;
    box-shadow: 0 0 0 .2rem rgba(40, 182, 44, .25)
}
...
.btn-primary:focus {
    ...
    background-color: #117298;
    border-color: #106a8c;
    box-shadow: 0 0 0 .2rem rgba(56, 157, 196, .5)
}
...
.btn-success:focus {
    ...
    background-color: #219724;
    border-color: #1f8c22;
    box-shadow: 0 0 0 .2rem rgba(72, 193, 76, .5)
}
...
.btn-info:focus {
    ...
    background-color: #54bde6;
    border-color: #48b9e5;
    box-shadow: 0 0 0 .2rem rgba(138, 210, 238, .5)
}
...
.btn-warning:focus {
    ...
    background-color: #f47100;
    border-color: #e76b00;
    box-shadow: 0 0 0 .2rem rgba(255, 151, 61, .5)
}
...
.btn-outline-primary:focus {
    box-shadow: 0 0 0 .2rem rgba(21, 140, 186, .5)
}
...
.btn-outline-success:focus {
    box-shadow: 0 0 0 .2rem rgba(40, 182, 44, .5)
}
...
.btn-outline-info:focus {
    box-shadow: 0 0 0 .2rem rgba(117, 202, 235, .5)
}
...
.custom-checkbox .custom-control-input:disabled:checked~.custom-control-label::before {
    background-color: rgba(21, 140, 186, .5)
}
...
.custom-range:focus::-webkit-slider-thumb {
    box-shadow: 0 0 0 1px #b0b0b0, 0 0 0 .2rem rgba(21, 140, 186, .25)
}
