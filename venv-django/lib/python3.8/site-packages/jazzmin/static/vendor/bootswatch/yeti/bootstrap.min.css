...
.valid-tooltip {
    ...
    line-height: 1.5;
    color: #b0b0b0;
    background-color: rgba(67, 172, 106, .9);
    border-radius: 0
}
...
.was-validated .form-control:valid:focus {
    border-color: #43ac6a;
    box-shadow: 0 0 0 .2rem rgba(67, 172, 106, .25)
}
...
.was-validated .custom-select:valid {
    ...
    background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='4' height='5' viewBox='0 0 4 5'%3e%3cpath fill='%23333' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") right .5rem center/8px 10px no-repeat, #b0b0b0 url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='8' height='8' viewBox='0 0 8 8'%3e%3cpath fill='%2343ac6a' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e") center right 1.5rem/calc(.75em + .375rem) calc(.75em + .375rem) no-repeat
}
...
.invalid-tooltip {
    ...
    line-height: 1.5;
    color: #b0b0b0;
    background-color: rgba(240, 65, 36, .9);
    border-radius: 0
}
...
.btn-primary:focus {
    ...
    background-color: #006f94;
    border-color: #006687;
    box-shadow: 0 0 0 .2rem rgba(38, 157, 196, .5)
}
...
.btn-success:focus {
    ...
    background-color: #389059;
    border-color: #358753;
    box-shadow: 0 0 0 .2rem rgba(95, 184, 128, .5)
}
...
.btn-warning:focus {
    ...
    background-color: #c37902;
    border-color: #b67102;
    box-shadow: 0 0 0 .2rem rgba(236, 161, 40, .5)
}
...
.btn-danger:focus {
    ...
    background-color: #df2d0f;
    border-color: #d32a0e;
    box-shadow: 0 0 0 .2rem rgba(242, 94, 69, .5)
}
...
.btn-outline-success:focus {
    box-shadow: 0 0 0 .2rem rgba(67, 172, 106, .5)
}
...
.btn-outline-warning:focus {
    box-shadow: 0 0 0 .2rem rgba(233, 144, 2, .5)
}
...
.btn-outline-danger:focus {
    box-shadow: 0 0 0 .2rem rgba(240, 65, 36, .5)
}
...
.custom-select {
    ...
    color: #495057;
    vertical-align: middle;
    background: #b0b0b0 url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='4' height='5' viewBox='0 0 4 5'%3e%3cpath fill='%23333' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") right .5rem center/8px 10px no-repeat;
    border: 1px solid #ccc;
    border-radius: 0;
    -webkit-appearance: none;
    -moz-appearance: none;
...
.custom-range:focus::-webkit-slider-thumb {
    box-shadow: 0 0 0 1px #b0b0b0, 0 0 0 .2rem rgba(0, 140, 186, .25)
}
