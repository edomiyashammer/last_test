...
<script type="text/javascript">
    (function (ETB) {
        ETB(document).ready(function (ETB) {
            ETB('tr input.action-select').actions();
        });
    })(django.jQuery);
</script>
{% endif %}
                    ...
                    <div class="filter-filers-container-inner">
                        ...
                        <div class="filter-search-wrapper">
                            ...
                            <ul class="filer-dropdown-menu filer-dropdown-menu-checkboxes">
                                <span class="fa fa-close js-close-dropdown-menu-checkboxes"><span class="sr-only">{%
                                        trans "Close" %}</span></span>
                                <li>
                                    <p>{% trans "Limit" %}</p>
                                    <label>
                                        <input type="checkbox" id="limit_search_to_folder" name="limit_search_to_folder"
            ...
            <div class="navigator-tools">
                ...
                <div class="navigator-button-wrapper">
                    ...
                    <a href="{% url 'admin:filer-directory_listing-make_root_folder' %}?parent_id={{ folder.id }}{% if is_popup %}&amp;_popup=1{% endif %}"
                        title="{% trans 'Adds a new Folder' %}" class="navigator-button"
                    ...
                    <span
                        class="js-upload-button-disabled upload-button-disabled js-filer-tooltip filer-tooltip-wrapper"
...
<div id="content-main">
    ...
    <div
        class="js-navigator navigator{% if not actions_on_top and not actions_on_bottom %}navigator-no-actions{% endif %}">
